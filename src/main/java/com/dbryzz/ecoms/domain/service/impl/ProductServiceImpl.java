...
import com.dbryzz.ecoms.domain.repository.ProductRepository;
...
//    private final Path root = Paths.get("uploads");
    ...
    public String saveProduct(Long userId,
                              ProductPostDTO productDTO, MultipartFile productImage) {
...
*/
  ...
  /*  private Object CopyToFromProductDTO(Object obj1, Object obj2) {
    ...
    private Product copyProductDTOtoProduct(ProductPostDTO productDTO, Product product) {
    ...
    public ProductPostDTO getJson(String product) {
        ProductPostDTO productJson = new ProductPostDTO();

        try {
            ObjectMapper objectMapper = new ObjectMapper();
            productJson = objectMapper.readValue(product, ProductPostDTO.class);
